...
public class BenefitPayFlutterPlugin implements MethodChannel.MethodCallHandler, FlutterPlugin, ActivityAware, EventChannel.StreamHandler {
...
//                delegate.saveStateBeforeResult();
    ...
    private TapBenefitPaySDKDelegate delegate;
     ...
     */
    public BenefitPayFlutterPlugin() {
    }
...
//            lifecycle.addObserver(observer);
    ...
    private TapBenefitPaySDKDelegate constructDelegate(final Activity setupActivity) {
        return new TapBenefitPaySDKDelegate(setupActivity);
    }
