...
/** BanefitPayFlutterPlugin */
public class BanefitPayFlutterPlugin implements MethodChannel.MethodCallHandler, FlutterPlugin, ActivityAware, EventChannel.StreamHandler {
...
//                delegate.saveStateBeforeResult();
  ...
  private TapBanefitPaySDKDelegate delegate;
  ...
  public static void registerWith(PluginRegistry.Registrar registrar) {
    ...
    BanefitPayFlutterPlugin plugin = new BanefitPayFlutterPlugin();
   ...
   */
  public BanefitPayFlutterPlugin() {
  }
  ...
  public void onAttachedToEngine(FlutterPluginBinding binding) {
    ...
    pluginBinding.getPlatformViewRegistry()
            .registerViewFactory("plugin/banefit_pay_view", new TapBanefitViewFactory());
  }
  ...
  private void setup(
    ...
    channel = new MethodChannel(messenger, "banefit_pay_flutter");
    channel.setMethodCallHandler(this);
    eventChannel = new EventChannel(messenger, "banefit_pay_event");
...
//            lifecycle.addObserver(observer);
  ...
  private TapBanefitPaySDKDelegate constructDelegate(final Activity setupActivity) {
    return new TapBanefitPaySDKDelegate(setupActivity);
  }
